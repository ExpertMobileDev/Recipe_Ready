...
@interface SocialFeedDetailVC : UIViewController
...
@property (strong, nonatomic) RecipeDetail* aRecipeDetail;
@property (assign, nonatomic) int nStarMark;
@property (assign, nonatomic) BOOL bCanReadPhoto;
